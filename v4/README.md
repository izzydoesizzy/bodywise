...
This is **v4** in the repo: v2's design and copy, plus a de-densification pass over the text-heavy
sections. New in v4 (all in `css/styles.css` under "v4 additions"): pull quotes, callouts, a
3-step Observe/Record/Interpret stepper, stat chips, checkmark grids, pill tags, a native
`<details>` accordion for workshop offerings, the "You are welcome here" litany, and Q&A blocks.
No JS was added; the accordion is plain HTML. See the top-level [`README.md`](../README.md) for how
the versions relate.
